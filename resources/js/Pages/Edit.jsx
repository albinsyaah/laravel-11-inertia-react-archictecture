...
export default function Edit({ post }) {
    ...
    return (
        <>
            ...
            <div className="m-4 text-2xl font-bold text-center">Edit Post</div>
            ...
            <form onSubmit={submit} className="m-5 mt-4 bg-white p-6 rounded shadow-md">
                ...
                <button type="submit" disabled={processing} className="bg-blue-500 text-white px-4 py-2 rounded w-full text-center">Edit Post</button>
            </form>
        </>
    )
};